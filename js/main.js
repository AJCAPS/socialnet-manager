...
const SUPABASE_URL = 'https://jmuvantyqiotepdxqnsi.supabase.co'
const SUPABASE_PUBLISHABLE_KEY = 'sb_publishable_xmY1u08VfgZwxXuO0PquaQ_MIWNGKXz'
...
if (found.length === 0) {
setStatus(`Error: No profile named "${friendName}" exists. Add that
profile first.`, true)
return
}
...
* The bidirectional canonical row is deleted. Both profiles stop seeing each
other.
